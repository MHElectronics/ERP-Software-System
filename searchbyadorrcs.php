        ...
        ***********************************-->
        ...
        if($result->num_rows >0){
            while ($row=$result->fetch_assoc()) {
                echo "<tr><td>".$row["MemberID"]."</td><td>".$row["Bank"]."</td><td>".$row["Bank"]."</td><td>".$row["ADOrRCS"]."</td><td>".$row["ChequeNo"]."</td><td>".$row["ChequeAmount"]."</td><td>".$row["ChequeHonoredDate"]."</td><td>".$row["ChequeDishonoredDate"]."</td><td>".$row["DishonorRemarks"]."</td></tr>";
            }
